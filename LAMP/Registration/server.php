...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM users WHERE username='$username' OR email='$email' LIMIT 1";  // linit 1 means new duplciates so you cannot have 2 accoutns wuth same username or email
